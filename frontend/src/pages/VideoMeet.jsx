...
import { Badge, IconButton, Paper, TextField, Input } from "@mui/material";
...
export default function VideoMeetComponent() {
  ...
  const addMessage = (data, sender, socketIdSender) => {
    ...
    if (socketIdSender !== socketIdRef.current && !setModal) {
      ...
      {askForUsername === true ? (
        <div>
          ...
          <video
            ...
            autoPlay
            muted
            style={{ width: "500px", height: "440px", borderRadius: "5px" }}
          ></video>
        </div>
      ) : (
                ...
                <div className={styles.chattingArea}>
                  ...
                  <Box sx={{ display: "flex", gap: 1, mb: 2 }}>
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      sx={{ flexGrow: 1 }}  // <-- THIS makes it expand
                    />
          ...
          <div className={styles.buttonContainers}>
            <Stack direction="row" spacing={2} justifyContent="center" mb={0.5}>
              ...
              <Tooltip title={screen ? "Stop Sharing" : "Share Screen"}>
                <IconButton color="white" onClick={handleScreen}>
